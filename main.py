...
def handle_client(client_socket):
    ...
    requestdata = request_data.decode('utf-8') #TODO: Evaluate necessety
    print(requestdata)

    content= urls.GB(path) # TODO: Get from urlpattern
    
    head = b"HTTP/1.1 200 OK\r\nContent-Length: " + str(len(content)).encode('utf-8')

    body = b"\r\n\r\n" + content # TODO: get response from variable TODO: confirm head/body split is correcct
